...
# Input sources
extension=fasta.gz                 # work only on '.fasta.gz' files
source_files=/home/miba8458/2020.03_GenomeAnalysisCourse/data/raw_ext/link_to_raw_data/genomics_data/Nanopore/
output_folder=/home/miba8458/2020.03_GenomeAnalysisCourse/results/reports/1_fastqc_DNA_Nanopore
