...
htseq-count -t CDS -i ID -f bam -s reverse ${input_mapped_RNA}/BHI_rep1/align_BHI_to_pacbio_sorted_rep1.bam ${input_annotation} > ${output_folder}/BHI_ERR1797972_rep1.txt
 
htseq-count -t CDS -i ID -f bam -s reverse ${input_mapped_RNA}/BHI_rep2/align_BHI_to_pacbio_sorted_rep2.bam ${input_annotation} > ${output_folder}/BHI_ERR1797973_rep2.txt 

htseq-count -t CDS -i ID -f bam -s reverse ${input_mapped_RNA}/BHI_rep3/align_BHI_to_pacbio_sorted_rep3.bam ${input_annotation} > ${output_folder}/BHI_ERR1797974_rep3.txt
