...
input_Canu_Pacbio=/home/miba8458/LnktoWorkingFolder/UppmaxDataLnk/scratch/2_DNA_canu_PacBio/canu_pacbio.contigs.fasta 
...
output_folder_rep1=/home/miba8458/2020.03_GenomeAnalysisCourse/scratch/10_RNA_bwa_second/serum_rep1
output_folder_rep2=/home/miba8458/2020.03_GenomeAnalysisCourse/scratch/10_RNA_bwa_second/serum_rep2
output_folder_rep3=/home/miba8458/2020.03_GenomeAnalysisCourse/scratch/10_RNA_bwa_second/serum_rep3
...
bwa mem -M ${input_Canu_Pacbio} ${source_serum_files}trim_paired_ERR1797969_pass_1.fastq.gz  ${source_serum_files}trim_paired_ERR1797969_pass_2.fastq.gz | \
samtools sort -o ${output_folder_rep1}/align_serum_to_pacbio_sorted_rep1.bam
 
bwa mem -M ${input_Canu_Pacbio} ${source_serum_files}trim_paired_ERR1797970_pass_1.fastq.gz  ${source_serum_files}trim_paired_ERR1797971_pass_2.fastq.gz | \
samtools sort -o ${output_folder_rep2}/align_serum_to_pacbio_sorted_rep2.bam 

bwa mem -M ${input_Canu_Pacbio} ${source_serum_files}trim_paired_ERR1797971_pass_1.fastq.gz  ${source_serum_files}trim_paired_ERR1797971_pass_2.fastq.gz | \
