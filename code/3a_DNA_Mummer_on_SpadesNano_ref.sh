...
output_folder_name=/home/miba8458/2020.03_GenomeAnalysisCourse/scratch/3a_DNA_mummer_onSpades_Nano_Illumina
reference_file=/home/miba8458/2020.03_GenomeAnalysisCourse/data/GCF_000174395.2_ASM17439v2_genomic.fna.gz
####################################

# Code to run
mummer -mum -b -L ${reference_file} ${input_Spades_Nano_Illumina} > Spades_PacBio_noPolish.mummer

mummerplot -t png Spades_PacBio_noPolish.mummer
